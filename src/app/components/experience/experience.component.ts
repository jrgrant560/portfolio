...
export class ExperienceComponent implements OnInit {
  ...
  calculateYears(date: number) {
    ...
    let todayMonthInYear: number = this.today.getMonth() / 12
    let yearsOfExp: number = (todayYear + todayMonthInYear) - date;
    return parseFloat(yearsOfExp.toFixed(1));
  }
  ...
  ExpDataModelSkills: ExpDataModel[] = [
    {
      ...
      subTitle: "",
      experience: this.calculateYears(2016 + (1 / 12)),
    ...
    },
    {
      ...
      title: "Google Suite",
      subTitle: "",
      experience: this.calculateYears(2015 + (9 / 12)),
    ...
    },
    {
      ...
      subTitle: "",
      experience: this.calculateYears(2008 + (8 / 12)),
  ...
  ExpDataModelEmployers: ExpDataModel[] = [
    {
      ...
      subTitle: "",
      experience: parseFloat(((2022 + (5 / 12)) - (2018 + (10 / 12))).toFixed(1)),
