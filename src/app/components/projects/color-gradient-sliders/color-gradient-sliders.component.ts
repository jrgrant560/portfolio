...
@Component({
  selector: 'app-color-gradient-sliders',
  templateUrl: './color-gradient-sliders.component.html',
  styleUrls: [
    './color-gradient-sliders.component.css',
    '../color-sliders/color-sliders-stylesheets/color-sliders.component.palette-squares.css',
    '../color-sliders/color-sliders-stylesheets/color-sliders.component.options.css',
    '../project-rows.css']
})
export class ColorGradientSlidersComponent implements OnInit {
